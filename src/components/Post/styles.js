...
export {Body, BodyPost, VerticalStack, HorizontalStack, Likes, Hashtag, SnippetBody, SnippetImage, SnippetTitle, SnippetDescription, SnippetUrl, ChangeArea, PostForm,PostDescription,  Content, ConfirmBox, ConfirmCard, CheckAnswer, GoBackButton, ConfirmButton, Input}